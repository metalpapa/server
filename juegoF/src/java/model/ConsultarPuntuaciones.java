...
public class ConsultarPuntuaciones {
    ...
    public List<String> partidas(){
                ...
                String selectString ="select p.nivel, j.jugador_id, p.duracion, p.puntuacion, j.apodo from jugador j, partida p, juego g where j.jugador_id=g.jugador_id and g.partida_id=p.partida_id and p.completa=1 and p.terminada=1 and p.nivel='"+nivel+"'  order by p.puntuacion desc  limit 15 ";
